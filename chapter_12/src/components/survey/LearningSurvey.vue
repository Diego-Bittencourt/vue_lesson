...
export default {
  ...
  methods: {
    submitSurvey() {
      ...
      fetch('https://vue-http-demo-69dfb-default-rtdb.asia-southeast1.firebasedatabase.app/surveys.json', {
        method: 'POST', //it tells the type of the http request. POST to send data, GET, DELETE and PATCH (patch is delete and update)
        header: {
